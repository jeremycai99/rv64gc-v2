...
BOTTLENECK_COUNTERS = [
    ...
    ("xs_bottleneck_iq0_short_alu_chain_issue", "issue/wakeup bypass", "IQ0 port1 uops issued through the local short-ALU chain from port0"),
    ("xs_bottleneck_iq0_short_alu_chain_src1", "issue/wakeup bypass", "IQ0 short-ALU chain issues where rs1 was forwarded from ALU0"),
    ("xs_bottleneck_iq0_short_alu_chain_src2", "issue/wakeup bypass", "IQ0 short-ALU chain issues where rs2 was forwarded from ALU0"),
    ("xs_bottleneck_iq0_short_alu_chain_both", "issue/wakeup bypass", "IQ0 short-ALU chain issues where both operands were forwarded from ALU0"),
