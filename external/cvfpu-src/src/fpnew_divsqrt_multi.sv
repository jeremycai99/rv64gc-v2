...
module fpnew_divsqrt_multi #(
  ...
  // Guard against NUM_INP_REGS==0 where [NUM_INP_REGS-1] wraps to [-1]
  // and crashes the Verilator DFG peephole optimizer.
  localparam int unsigned SAFE_INP_IDX = NUM_INP_REGS > 0 ? NUM_INP_REGS - 1 : 0;
  `FF(ext_op_start_q, reg_ena_i[SAFE_INP_IDX], 1'b0)
  ...
  assign unit_done_clear = simd_synch_done | reg_ena_i[SAFE_INP_IDX];
  ...
  div_sqrt_top_mvp i_divsqrt_lei (
   ...
   .Kill_SI          ( flush_i | reg_ena_i[SAFE_INP_IDX] ),
