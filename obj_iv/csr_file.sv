        ...
        if (!rst_n) begin
            ...
            if (trap_valid) begin
                ...
                case (write_addr)
                    ...
                    CSR_SSTATUS:
                    begin
                        logic [63:0] _nm = ((mstatus_r & ~SSTATUS_WMASK) |
                    ...
                    CSR_MSTATUS:
                    begin
                        logic [63:0] _nm = (((write_op == 2'd0) ? (write_data) : (write_op == 2'd1) ? ((mstatus_r) | (write_data)) : (write_op == 2'd2) ? ((mstatus_r) & ~(write_data)) : (mstatus_r)));
                        _nm[35:34] = 2'b10;
                        _nm[33:32] = 2'b10;
                        _nm[63]    = (_nm[14:13] == 2'b11) || (_nm[16:15] == 2'b11);
                        mstatus_r <= _nm;
