...
- `release_candidate_signoff_2026-05-29.md` - **RELEASE CANDIDATE signoff** —
  ...
  Dhrystone 4.27 DMIPS/MHz — both above the reference OoO core's public floor), the release gates,
...
- `archive/stage1/` - Stage 1 frontend-refactor status; reference OoO core comparison.
...
- `archive/reference_core/` - reference-core unified audit + provenance and
  feature matrix for comparable open OoO cores.
