...
(
    ...
    output reg                    dtlb_req_ready_o,

    input  wire                    itlb_req_valid_i,
    input  wire [63:0]             itlb_req_va_i,
    output reg                    itlb_req_ready_o,

    output reg                    dtlb_fill_valid_o,
    output reg                    itlb_fill_valid_o,
    output reg [35:0]             fill_vpn_o,
    output reg [43:0]             fill_ppn_o,
    output reg [15:0]             fill_asid_o,
    output reg [1:0]              fill_page_size_o,
    output reg [7:0]              fill_perm_o,
    output reg [63:0]             fill_pte_pa_o,

    output reg                    fault_valid_o,
    output reg                    fault_is_itlb_o,
    output reg                    fault_is_store_o,
    output reg [ROB_IDX_BITS-1:0] fault_rob_idx_o,
    output reg [63:0]             fault_va_o,

    output reg                    dirty_wb_ready_o,
    ...
    output reg                    dcache_store_valid_o,
    output reg [63:0]             dcache_store_addr_o,
    output reg [63:0]             dcache_store_data_o,
