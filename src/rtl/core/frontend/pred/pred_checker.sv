...
(
    ...
    input  wire                         stall_i,
    input  wire                         seed_clear_i,
    input  wire                         seed_consume_i,
    input  wire [63:0]                  req_pc_i,
    ...
    input  wire [63:0]                  btb_target_i,
    input  wire [2:0]                   btb_type_i,
    input  wire [5:0]                   btb_offset_i,
    input  wire                         btb_alt_hit_i,
    input  wire [63:0]                  btb_alt_target_i,
    input  wire [2:0]                   btb_alt_type_i,
    input  wire [5:0]                   btb_alt_offset_i,
    input  wire                         tage_taken_i,

    input  wire [4:0]                   ras_tos_i,
    input  wire [63:0]                  ras_pop_addr_i,

    input  wire                         pd_ctl_found_i,
    input  wire [2:0]                   pd_ctl_slot_i,
    input  wire [2:0]                   pd_ctl_type_i,
    input  wire [63:0]                  pd_ctl_pc_i,
    input  wire [63:0]                  pd_ctl_target_i,

    input  wire                         second_ctl_found_i,
    input  wire [2:0]                   second_ctl_slot_i,
    input  wire [2:0]                   second_ctl_type_i,
    input  wire [63:0]                  second_ctl_pc_i,
    input  wire [63:0]                  second_ctl_target_i,
    input  wire                         owner_cond_pred_found_i,

    input  wire                         seq_valid_i,
    input  wire                         consume_remainder_i,
    input  wire                         redirect_without_owner_successor_i,
    input  wire                         straddle_detected_i,

    output reg                         ftq_pred_ctl_valid_o,
    output reg                         ftq_pred_ctl_slot_match_o,
    output reg                         ftq_pred_ctl_taken_o,
    output reg [2:0]                   ftq_pred_ctl_slot_o,
    output reg [2:0]                   ftq_pred_ctl_type_o,
    output reg [63:0]                  ftq_pred_ctl_target_o,
    output reg                         pd_pred_mismatch_o,

    output reg                         bp_branch_found_o,
    output reg                         bp_taken_o,
    output reg [2:0]                   bp_branch_slot_o,
    output reg [2:0]                   bp_type_o,
    output reg [63:0]                  bp_target_o,

    output reg                         subgroup_split_before_ctl_o,
    output reg                         subgroup_split_seed_o,
    output reg [2:0]                   subgroup_split_slot_o,
    output reg [2:0]                   subgroup_split_type_o,
    output reg [63:0]                  subgroup_split_pc_o,
    output reg [63:0]                  subgroup_split_target_o,
    output reg                         subgroup_seed_load_o,
    output reg                         subgroup_seed_pred_taken_o,
    output reg                         subgroup_seed_hit_o,
    output reg                         subgroup_seed_valid_o,
    output reg [63:0]                  subgroup_seed_pc_o,
    output reg [63:0]                  subgroup_seed_parent_pc_o,
    output reg [63:0]                  subgroup_seed_owner_pc_o,
    output reg                         subgroup_seed_pred_valid_o,
    output reg                         subgroup_seed_pred_taken_state_o,
    output reg [5:0]                   subgroup_seed_pred_offset_o,
    output reg [2:0]                   subgroup_seed_pred_type_o,
    output reg [63:0]                  subgroup_seed_pred_target_o,

    output reg [2:0]                   final_count_o,
    output reg                         same_owner_continue_o,
    output reg                         owner_complete_o,
    output reg                         successor_req_valid_o,
    output reg [63:0]                  successor_req_pc_o,
    output reg                         req_redirect_o,
    output reg                         bpu_redirect_o,
    output reg [63:0]                  bpu_target_o,

    output reg                         ras_push_valid_o,
    output reg [63:0]                  ras_push_addr_o,
    output reg                         ras_pop_valid_o,
    output reg                         tage_spec_update_valid_o,
    output reg                         tage_spec_taken_o,
    output reg                         tage_loop_spec_update_valid_o,
    output reg                         tage_loop_spec_taken_o
);
