...
(
    ...
    input  logic                          has_emit_payload_i,
    ...
    input  logic                          work_ftq_valid_i,
    input  logic [63:0]                   work_pc_i,
    input  logic [FTQ_IDX_BITS-1:0]       work_ftq_idx_i,
    input  logic [FTQ_EPOCH_BITS-1:0]     work_ftq_epoch_i,
    input  logic [FTQ_ALLOC_TAG_BITS-1:0] work_ftq_alloc_tag_i,
