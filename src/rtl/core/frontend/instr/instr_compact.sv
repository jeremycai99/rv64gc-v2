...
(
    ...
    input  wire [FTQ_IDX_BITS-1:0]      ftq_idx_i,
    input  wire [FTQ_EPOCH_BITS-1:0]    ftq_epoch_i,
    input  wire [FTQ_ALLOC_TAG_BITS-1:0] ftq_alloc_tag_i,
    input  wire                         ftq_owner_complete_i,
    input  ftq_entry_t                   ftq_entry_i,
    input  wire                         ftq_valid_i,

    input  wire [63:LINE_BITS]          ifu_line_addr_i,
    input  wire                         ifu_line_reused_i,

    input  wire                         subgroup_seed_valid_i,
    input  wire [63:0]                  subgroup_seed_parent_pc_i,
    input  wire [63:0]                  subgroup_seed_owner_pc_i,
    ...
    input  wire [2:0]                   bp_branch_slot_i,
