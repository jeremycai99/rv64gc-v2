...
(
    ...
    output reg [FTQ_IDX_BITS-1:0]      enq_idx,
    output reg [FTQ_EPOCH_BITS-1:0]    enq_epoch,
    output reg [FTQ_ALLOC_TAG_BITS-1:0] enq_tag,
    ...
    output reg [FTQ_IDX_BITS-1:0]      head_idx,
    output reg [FTQ_ALLOC_TAG_BITS-1:0] head_tag,

    output reg                         ifu_owner_valid,
    output ftq_entry_t                   ifu_owner_entry,
    output reg [FTQ_IDX_BITS-1:0]      ifu_owner_idx,
    output reg [FTQ_ALLOC_TAG_BITS-1:0] ifu_owner_tag,
    output reg                         ifu_wb_owner_valid,
    output ftq_entry_t                   ifu_wb_owner_entry,
    output reg [FTQ_IDX_BITS-1:0]      ifu_wb_owner_idx,
    output reg [FTQ_ALLOC_TAG_BITS-1:0] ifu_wb_owner_tag,
    output reg                         next_ifu_owner_valid,
    output ftq_entry_t                   next_ifu_owner_entry,
    output reg [FTQ_IDX_BITS-1:0]      next_ifu_owner_idx,
    output reg [FTQ_ALLOC_TAG_BITS-1:0] next_ifu_owner_tag,

    input  wire                         commit_pop_valid,
    output reg                         commit_head_valid,
    output ftq_entry_t                   commit_head_entry,
    output reg [FTQ_IDX_BITS-1:0]      commit_head_idx,
    output reg [FTQ_ALLOC_TAG_BITS-1:0] commit_head_tag,

    output reg                         commit_owner_valid,
    output ftq_entry_t                   commit_owner_entry,
    output reg [FTQ_IDX_BITS-1:0]      commit_owner_idx,
    output reg [FTQ_ALLOC_TAG_BITS-1:0] commit_owner_tag,

    output reg [FTQ_EPOCH_BITS-1:0]    current_epoch,
    output reg [FTQ_IDX_BITS:0]        count,
    output reg [FTQ_IDX_BITS:0]        count_alloc_to_ifu,
    output reg [FTQ_IDX_BITS:0]        count_ifu_to_wb,
    output reg [FTQ_IDX_BITS:0]        count_ifu_to_commit,
    output reg                         full,
    output reg                         empty
);
