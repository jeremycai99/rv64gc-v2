...
(
    ...
    input  wire [63:0]             lookup_pc_i,
    input  wire [63:0]             lookup_block_pc_i,
    input  wire [63:0]             aux_lookup_pc_i,

    output reg                    btb_hit_o,
    output reg [63:0]             btb_target_o,
    output reg [2:0]              btb_type_o,
    output reg [5:0]              btb_offset_o,
    output reg                    btb_alt_hit_o,
    output reg [63:0]             btb_alt_target_o,
    output reg [2:0]              btb_alt_type_o,
    output reg [5:0]              btb_alt_offset_o,

    output reg                    aux_btb_hit_o,
    output reg [63:0]             aux_btb_target_o,
    output reg [2:0]              aux_btb_type_o,
    output reg [5:0]              aux_btb_offset_o,
    output reg                    aux_btb_alt_hit_o,
    output reg [63:0]             aux_btb_alt_target_o,
    output reg [2:0]              aux_btb_alt_type_o,
    output reg [5:0]              aux_btb_alt_offset_o,

    output reg                    tage_pred_taken_o,
    output reg                    tage_pred_confident_o,
    input  wire [63:0]             aux_tage_pc_i,
    input  wire [63:0]             aux_tage_target_i,
    input  wire [GHR_BITS-1:0]     aux_tage_ghr_i,
    output reg                    aux_tage_pred_taken_o,
    output reg                    aux_tage_pred_confident_o,

    input  wire                    btb_update_valid_i,
    input  wire [63:0]             btb_update_pc_i,
    input  wire [63:0]             btb_update_target_i,
    input  wire [2:0]              btb_update_type_i,

    input  wire                    tage_update_valid_i,
    input  wire [63:0]             tage_update_pc_i,
    input  wire [63:0]             tage_update_target_i,
    input  wire                    tage_update_taken_i,
    input  wire                    tage_update_mispredict_i,
    input  wire [GHR_BITS-1:0]     tage_update_ghr_i,

    input  wire                    tage_spec_update_valid_i,
    input  wire                    tage_spec_taken_i,
    input  wire [63:0]             tage_spec_pc_i,
    input  wire [63:0]             tage_spec_target_i,
    input  wire                    tage_loop_spec_update_valid_i,
    input  wire                    tage_loop_spec_taken_i,
    input  wire                    ghr_restore_valid_i,
    input  wire [GHR_BITS-1:0]     ghr_restore_val_i,
    output reg [GHR_BITS-1:0]     ghr_o,

    input  wire                    f2_stall_i,
    input  wire                    f2_capture_i,
    input  wire                    f2_redirect_i,
    input  wire                    f2_line_straddle_advance_i,
    input  wire                    f2_consume_remainder_i,
    input  wire                    f2_consumed_remainder_i,
    output reg                    f2_btb_hit_o,
    output reg [63:0]             f2_btb_target_o,
    output reg [2:0]              f2_btb_type_o,
    output reg [5:0]              f2_btb_offset_o,
    output reg                    f2_btb_alt_hit_o,
    output reg [63:0]             f2_btb_alt_target_o,
    output reg [2:0]              f2_btb_alt_type_o,
    output reg [5:0]              f2_btb_alt_offset_o,
    output reg                    f2_tage_taken_o,
    output reg [GHR_BITS-1:0]     f2_ghr_snapshot_o,

    input  wire                    subgroup_seed_hit_i,
    input  wire                    subgroup_seed_pred_valid_i,
    input  wire                    subgroup_seed_pred_taken_i,
    input  wire [5:0]              subgroup_seed_pred_offset_i,
    input  wire [2:0]              subgroup_seed_pred_type_i,
    input  wire [63:0]             subgroup_seed_pred_target_i,
    output ftq_entry_t              req_ftq_entry_o,
    output reg                    aux_pred_ctl_valid_o,
    output reg                    aux_pred_ctl_taken_o,
    output reg [5:0]              aux_pred_ctl_offset_o,
    output reg [2:0]              aux_pred_ctl_type_o,
    output reg [63:0]             aux_pred_ctl_target_o,

    input  wire                    ras_push_valid_i,
    input  wire [63:0]             ras_push_addr_i,
    input  wire                    ras_pop_valid_i,
    output reg [63:0]             ras_pop_addr_o,
    output reg [4:0]              ras_tos_o,
    input  wire                    ras_clear_i,
    input  wire                    ras_restore_valid_i,
    input  wire [4:0]              ras_restore_tos_i,
    input  wire                    ras_restore_top_valid_i,
    input  wire [63:0]             ras_restore_top_addr_i
);
    ...
    tage_sc_l u_tage_sc_l (
        ...
        .loop_spec_update_valid (tage_loop_spec_update_valid_i),
        .loop_spec_taken        (tage_loop_spec_taken_i),
