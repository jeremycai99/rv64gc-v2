...
(
    ...
    input  wire [63:0]                      ic_req_addr,
    input  wire                             ic_resp_valid,
    input  wire                             ic_resp_hit,
    input  wire                             nlpb_hit_comb,
    input  wire                             f2_work_valid_c,
    input  wire [63:0]                      f2_work_pc_c,
    input  wire                             f2_btb_hit_r,
    input  wire [2:0]                       f2_btb_type_r,
    input  wire [5:0]                       f2_btb_offset_r,
    input  wire                             f2_btb_alt_hit_r,
    input  wire [2:0]                       f2_btb_alt_type_r,
    input  wire [5:0]                       f2_btb_alt_offset_r,
    ...
    input  wire                             bp_branch_found,
    input  wire                             bp_taken,
    input  wire [2:0]                       bp_type,
    input  wire [2:0]                       bp_branch_slot,
    input  wire [63:0]                      bp_target_addr,
    input  wire                             predecode_ctl_found,
    input  wire [2:0]                       predecode_ctl_slot,
    input  wire [2:0]                       predecode_ctl_type,
    input  wire [63:0]                      predecode_ctl_pc,
    input  wire [63:0]                      predecode_ctl_target,
    input  wire                             ftq_pred_ctl_valid,
    input  wire                             ftq_pred_ctl_taken,
    input  wire [2:0]                       ftq_pred_ctl_slot,
    input  wire [2:0]                       ftq_pred_ctl_type,
    input  wire                             pd_pred_mismatch,
    input  wire                             subgroup_seed_valid_r,
    input  wire [63:0]                      subgroup_seed_pc_r,
    input  wire                             subgroup_seed_pred_taken_r,
    input  wire [63:0]                      subgroup_seed_parent_pc_r,
    input  wire [63:0]                      subgroup_seed_owner_pc_r,
    input  wire [4:0]                       ras_tos,
    input  wire                             ras_push_valid,
    input  wire [63:0]                      ras_push_addr,
    input  wire                             ras_pop_valid,
    input  wire [63:0]                      ras_pop_addr,
    input  wire                             f2_bpu_redirect,
    input  wire [63:0]                      f2_bpu_target,
    input  wire                             redirect_valid,
    input  wire [63:0]                      redirect_pc,
    input  wire                             remainder_valid_r,
    ...
    input  wire                             ftq_head_valid,
    input  wire [FTQ_IDX_BITS-1:0]          ftq_head_idx,
    input  wire [FTQ_ALLOC_TAG_BITS-1:0]    ftq_head_tag,
    ...
    input  wire [63:0]                      f2_replay_block_pc_r,
    input  wire [1:0]                       f2_replay_block_age_r,
    ...
    input  wire                             packet_buf_head_owner_complete_c,
    input  wire                             subgroup_seed_load_c,
    input  wire [63:0]                      subgroup_split_pc_c,
    input  wire [63:0]                      subgroup_split_target_c,
    input  wire [2:0]                       subgroup_split_slot_c,
    input  wire [2:0]                       subgroup_split_type_c,
    input  wire                             subgroup_split_seed_c,
    input  wire [63:0]                      second_ctl_pc,
    input  wire [63:0]                      second_ctl_target,
    input  wire                             owner_cond_pred_found
);
