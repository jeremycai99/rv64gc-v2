...
(
    ...
    input  wire                             f2_pc_consumed_c,
    input  wire                             icq_deq_owner_match_c,
    input ftq_entry_t                       icq_deq_ftq_entry,
    input ftq_entry_t                       ftq_ifu_wb_owner_entry,
    input  wire [FTQ_IDX_BITS-1:0]          icq_deq_ftq_idx,
    input  wire [FTQ_ALLOC_TAG_BITS-1:0]    icq_deq_ftq_alloc_tag,
    input  wire [FTQ_IDX_BITS-1:0]          ftq_ifu_wb_owner_idx,
    input  wire [FTQ_ALLOC_TAG_BITS-1:0]    ftq_ifu_wb_owner_tag,
    input  wire                             f2_line_state_use_c,
    input  wire                             f2_line_state_valid_c,
    input  wire [63:LINE_BITS]              f2_line_state_addr_c,
    input  wire [FTQ_EPOCH_BITS-1:0]        f2_line_state_epoch_c,
    ...
    input  wire                             ifu_work_redirect_next_owner_match_c,
    input  wire [63:0]                      f2_bpu_target,
    ...
    input  wire [FTQ_IDX_BITS-1:0]          ifu_runahead_pending_idx_c,
    input  wire [FTQ_EPOCH_BITS-1:0]        ifu_runahead_pending_epoch_c,
    input  wire [FTQ_ALLOC_TAG_BITS-1:0]    ifu_runahead_pending_tag_c,
